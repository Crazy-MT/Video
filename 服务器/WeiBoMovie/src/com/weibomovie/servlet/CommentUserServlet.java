...
public class CommentUserServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public CommentUserServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getParameter("userid") != null ){
			...
			try {
				movieList = commentDao.getCommentFromUserId(Long.valueOf(request.getParameter("userid")));
