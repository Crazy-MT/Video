			...
			<table width="600" cellpadding="4" cellspacing="0" border="0">
				<tr>
					...
					<td width="80%"><input type="radio" name="broadcast" value="0"
						checked="checked" /> All (Broadcast) <input type="radio"
						name="broadcast" value="1" /> By Username <input type="radio"
						name="broadcast" value="2" /> By Alias <input type="radio"
						name="broadcast" value="3" /> By Tag</td>
				</tr>
