...
public class NotificationDetailsActivity extends Activity {
    ...
    private View createView(final String title, final String message,
        ...
        TextView textImageUrl = new TextView(this);
        textImageUrl.setText(imageUrl);
        textImageUrl.setTextSize(14);
        // textTitle.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        textImageUrl.setTextColor(0xff333333);
        textImageUrl.setGravity(Gravity.CENTER);

        layoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.FILL_PARENT,
                LinearLayout.LayoutParams.WRAP_CONTENT);
        layoutParams.setMargins(30, 10, 30, 20);
        textImageUrl.setLayoutParams(layoutParams);
        linearLayout.addView(textImageUrl);
